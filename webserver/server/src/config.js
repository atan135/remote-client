...
export function loadConfig() {
  return {
    ...
    jietuJsonLimit: process.env.JIETU_JSON_LIMIT || "20mb",
    jietuMaxUploadBytes: toNumber(process.env.JIETU_MAX_UPLOAD_BYTES, 15 * 1024 * 1024),
    jietuRequestTimeoutMs: toNumber(process.env.JIETU_REQUEST_TIMEOUT_MS, 30000),
